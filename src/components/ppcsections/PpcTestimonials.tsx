...
const testimonials = [
  ...
  },
  {
    ...
    review: "Their PPC expertise helped us scale quickly. From initial campaign setup to optimization, the Dash Media Solutions team focused on ROI at every stage. After launch, we witnessed traffic improvements and steady conversion growth within weeks.",
  },
  {
    ...
    review: "Working with Dash Media Solutions transformed our paid advertising strategy. Their data-driven approach, compelling ad copy, and precise audience targeting delivered higher click-through rates and measurable revenue growth.",
  },
];
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div className="max-w-3xl text-left">
                        ...
                        <p className="text-md sm:text-lg text-muted-foreground mt-6 leading-relaxed">
                          Listen to what our clients have to say about our pay-per-click (PPC) solutions and learn how they empower their marketing and user engagement.
                        </p>
                    </div>
                </div>
