...
export function AboutClientLogos() {
  ...
  return (
    <section className="pt-0 md:pb-25 bg-gray-50">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-4 sm:gap-8">
          ...
          <div className="w-full lg:w-2/5 text-center lg:text-center order-1 lg:order-2 mt-5 lg:mt-0">
            <h2 className="text-4xl md:text-6xl font-regular text-primary tracking-tighter">
              Our 
